...
|-----------|------|-------------|
| `type` | string | Filter by SDK type: `image`, `image_edit`, `video`, `video_from_image`, `music`, `speech`, `sound`. Also accepts raw model types like `text_to_img`, `image_editing`. |
...
<LiveModels type="image_edit" showAspectRatios />
...
<LiveModels type="video_from_image" showDurations showAspectRatios />
