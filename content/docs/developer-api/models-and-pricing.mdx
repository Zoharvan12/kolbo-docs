...
Kolbo provides 100+ AI models that are dynamically available. New models are added regularly and immediately accessible via the API.
...
| Generation | Credits |
|------------|---------|
| Flux Schnell image | ~2 |
| 5s Seedance video | ~25 |
| 10s Kling video | ~50 |
| Suno music track | ~10 |
| 500-char speech | ~5 |
| Sound effect | ~3 |

*Exact costs vary by model. Check the `credit` field on each model.*
